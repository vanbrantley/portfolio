            ...
            <div className="space-y-10">
                ...
                <div className="pl-4 border-l-2 border-blue-500 space-y-3">
                    ...
                    <ul className="space-y-2 text-slate-600 list-disc ml-5">
                        <li><span className="font-medium text-slate-900">LA</span> and <span className="font-medium text-slate-900">Ottawa</span> were significantly above the league average, proving sustained scouting excellence.</li>
